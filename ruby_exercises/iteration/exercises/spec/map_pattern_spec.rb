RSpec.describe 'map pattern' do
  ...
  it 'test 6' do
    ...
    squares = {}
    numbers.each do |title, val|
      squares[title] = val * val
    end
  ...
  it 'test 8' do
    ...
    family.each do |title, value|
      lengths[title] = value.length
    end
  ...
  it 'test 10' do
    ...
    backwards = {}
    family.each do |name, value|
      backwards[name] = value.reverse
