...
describe 'Advanced Nested Collections' do
  it 'test 1' do
    # EXAMPLE
  ...
  it 'test 9' do
    ...
    full_menu_price = stores[:olive_garden][:dishes].map {|key, value|
      key[:price]}.sum
  ...
  it 'test 10' do
    ...
    olive_garden_menu = {}
    stores[:olive_garden][:dishes].map do |dish, data| 
